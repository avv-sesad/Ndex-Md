...
exports.media = () => {
    return `pilih media yang akan di Download`
}
exports.replyImg = (prefix, command) => {
    return `reply foto menggunakan command : ${prefix + command}`
}

exports.wrongFormat = (prefix) => {
    return `format salah mohon ikuti petunjuk dengan benar`
}

exports.emptyMess = () => {
    return `harap isi pesan yang akan disampaikan`
}

exports.cmdNotFound = (cmd, prefix) => {
    return `maaf tidak ada fitur *${cmd}*`
}

exports.ownerOnly = () => {
    return `khusus digunakan oleh owner!`
}

exports.doneOwner = () => {
    return `selesi bang <3`
}

exports.groupOnly = () => {
    return `khusus digunakan didalam grup!`
}

exports.adminOnly = () => {
    return `khusus digunakan oleh admin grup!`
}
...
exports.notAdmin = () => {
    return `maaf kamu bukan admin`
}

exports.adminAlready = () => {
    return `tidak bisa menjadi admin jika sudah menjadi admin!`
}

exports.botNotAdmin = () => {
    return `mohon jadikan bot sebagai admin terlebih dahulu 🙏`
}
